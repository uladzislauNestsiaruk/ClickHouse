...
SETTINGS allow_fsst_serialization = 1, ratio_of_defaults_for_sparse_serialization = 0.95, min_avg_string_length_for_fsst_serialization = 1.0, min_total_bytes_for_fsst_serialization = 1024, max_fsst_compression_ratio = 1.0;
...
CREATE TABLE test_fsst_edge (id UInt64, s String) ENGINE = MergeTree ORDER BY id
SETTINGS allow_fsst_serialization = 1, min_avg_string_length_for_fsst_serialization = 1.0, min_total_bytes_for_fsst_serialization = 1024, max_fsst_compression_ratio = 1.0;
